...
class ArticleController extends Controller
{
    ...
    public function show()
    {
        ...
        foreach ($res as $row) {
            ...
            // $image = Image::make(FacadesFile::get(public_path('images') . config('global.ARTICLE_IMG_PATH') . $row->image));
            // $width = $image->width();
            // $height = $image->height();
            ...
            // $components_x = 4;
            // $components_y = 3;
            // echo   $image_hash = Blurhash::encode($pixels, $components_x, $components_y);
