...
class Paypal
{
    ...
    function __construct()
    {
        ...
        // helper('paypal');
        $sanbox = Setting::select('data')->where('type', 'sandbox_mode')->pluck('data')->first();
        ...
        $paypal_business = Setting::select('data')->where('type', 'paypal_business_id')->pluck('data')->first();

        $businessEmail = $paypal_business ? $paypal_business : '';
