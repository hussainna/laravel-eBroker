            ...
            <div class="card-content">
                <div class="card-body">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="form-group mendatory row">
                            ...
                            <div class="col-sm-3 ">
                                <select name="category" class="select2 form-select form-control-sm" id="category"
                                    required="required">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-12">
                                    <table class="table-light" aria-describedby="mydesc" class='table-striped'
                                        ...
                                        <thead>
                                            <tr>
                                                <th scope="col" data-field="id" data-halign="center"
                                                    data-sortable="true">ID</th>
                                                <th scope="col" data-field="image" data-halign="center"
                                                    data-sortable="false">Image</th>
                                                <th scope="col" data-field="category" data-halign="center"
                                                    data-sortable="false">Category</th>
                                                <th scope="col" data-field="title" data-halign="center"
                                                    data-sortable="false">Property</th>
