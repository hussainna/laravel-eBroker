                ...
                <div class="card-body">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-2 col-12 form-group ">
                            ...
                            {{ Form::text('duration', '', ['class' => 'form-control ', 'placeholder' => 'Package duration (in days)', 'id' => 'duration']) }}
                        ...
                        <div id="property_limitation" class="col-md-2 col-12 form-group" style="width: 165px;margin-left:30px">
                        ...
                        <div id="limitation_for_property" class="col-md-1 col-12 form-group">
                            {{ Form::label('limit', 'Limit', ['class' => 'form-label col-12 ']) }}

                            {{ Form::text('property_limit', '', ['class' => 'form-control', 'type' => 'number', 'min' => '1', 'pattern' => ' [0 - 9]', 'placeholder' => 'limitation', 'id' => 'propertylimit']) }}

                        </div>

                        <div id="property_limitation" class="col-md-2 col-12 form-group" style="width: 167px;margin-left:102px">
                        ...
                        {{-- </div> --}}
                        <div id="limitation_for_advertisement" class="col-md-1 col-12 form-group">

                            {{ Form::label('limit', 'Limit', ['class' => 'form-label col-12 ']) }}


                            {{ Form::text('advertisement_limit', '', ['class' => 'form-control ', 'type' => 'number', 'min' => '1', 'pattern' => ' [0 - 9]', 'placeholder' => 'limitation ', 'id' => 'advertisementlimit']) }}
                    ...
                    <table class="table-light" aria-describedby="mydesc" class='table-striped' id="table_list"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col" data-field="property_limit" data-halign="center" data-sortable="false">
                                    Limit For Property
                                </th>
                                <th scope="col" data-field="advertisement_limit" data-halign="center"
                                    data-sortable="false">
