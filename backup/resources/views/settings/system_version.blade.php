                ...
                <div class="card-body">
                    ...
                    <div class="row mt-1">
                        <div class="card-body">
                            ...
                            <label class="col-sm-12 col-form-label text-center">System Version
                                {{ system_setting('system_version') != '' ? system_setting('system_version') : '1.0.0' }}</label>
                            <div class="form-group row mt-5">


                                <label class="col-sm-2 col-form-label text-center">Purchase Code</label>
                                <div class="col-sm-3">
                                    <input required name="purchase_code" type="text" class="form-control">
                                </div>

                                <label class="col-sm-2 col-form-label text-center">Update File</label>
                                <div class="col-sm-3">
