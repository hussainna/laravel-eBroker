                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-1 col-md-1">
                                    ...
                                    <div class="form-check form-switch col-12"
                                        style={{ !$lang->rtl ? 'padding-left: 12.5rem;' : 'padding-right:12.5rem;' }}>
                                        {{ Form::checkbox('rtl_switch', '', false, ['class' => 'form-check-input', 'id' => 'rtl_switch']) }}
                                    </div>
                                    <input type="hidden" name="rtl" id="rtl">
                                </div>
                                <div class="col-sm-1 col-md-1">

                                    {{ Form::label('file', 'Sample for Admin Panel', ['class' => 'col-form-label text-center']) }}
                                    <div class="form-check form-switch col-12"
                                        style={{ !$lang->rtl ? 'padding-left: 12.5rem;' : 'padding-right:12.5rem;' }}>
...
@section('script')
    <script>
        ...
        $("#rtl_switch").on('change', function() {
            $("#rtl_switch").is(':checked') ? $("#rtl").val(1) : $(
                    "#rtl")
                .val(0);
        });
